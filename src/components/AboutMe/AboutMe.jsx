      ...
      <h1 className='about-me-title'>| About Me |</h1>
          <h6 className='descriptionMe animate__animated animate__fadeIn'>
              ...
              <span className='subtitles'>who I am?</span>
                ...
                I studied high school in Tepatitla de Morelos, my current city, at the Jalisco Regional High School (Graduate). In August 2021 I started my web development courses at UDEMY, starting with HTML, CSS, Responsive web pages, JavaScript and sass, later I took a bootcamp at CoderHouse for React.js
